...
def main():
    ...
    root_dataset = args.root_dataset or ".."
    ...
    # Create clients
    clients = setup_clients(args.dataset, client_model, args.use_val_set, root_dataset)
    ...
    print_stats(
        0, server, clients, client_num_samples, args, stat_writer_fn, args.use_val_set
    )
...
def create_clients(users, groups, train_data, test_data, model):
    ...
    clients = [
        Client(u, g, train_data[u], test_data[u], model) for u, g in zip(users, groups)
    ]
    return clients


def setup_clients(dataset, model=None, use_val_set=False, root_dataset=".."):
    ...
    train_data_dir = os.path.join(root_dataset, "data", dataset, "data", "train")
    test_data_dir = os.path.join(root_dataset, "data", dataset, "data", eval_set)
